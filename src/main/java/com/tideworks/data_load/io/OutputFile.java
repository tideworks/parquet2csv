...
public final class OutputFile {
  ...
  private static PositionOutputStream makePositionOutputStream(@Nonnull Path file, int ioBufSize, boolean trunc)
        throws IOException
  {
    return makePositionOutputStream(() -> new BufferedOutputStream(
  ...
  public static PositionOutputStream makePositionOutputStream(final OutputStreamSupplier getOutputStream)
        throws IOException
  {
    final OutputStream output = getOutputStream.get();
